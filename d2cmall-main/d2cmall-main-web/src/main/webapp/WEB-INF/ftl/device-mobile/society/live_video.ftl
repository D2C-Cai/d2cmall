    ...
    <#if live.status==1 ||  live.status==2 ||  live.status== 0>
        ...
        <div class="video">
            <div id="player">
                <video id="video" webkit-playsinline="true" x-webkit-airplay="true" playsinline="true"
                       x5-video-player-type="h5" x5-video-player-fullscreen="true" loop="loop" width="100%"
                       preload="auto" style="background: rgb(0, 0, 0);object-fit: fill;"
                       <#if live.cover>poster="${picture_base}${(live.cover)!}"</#if> >
                    <source type="application/x-mpegurl"
                            src="<#if live.status==1>${live.hlsUrl}<#elseif live.status==2>${live.replayUrl}</#if>">
        ...
        <div style="width:100%;background-color:#000;opacity:0.7;position:absolute;top:0;left:0;display:block;z-index:20;height:100%;display:none"
            ...
            <div>
                ...
                <div class="watchinfo">
                    <div><p style="color:#FFF">${live.watched}</p>
                        <p style="font-size:0.6em">观看人数</p></div>
                    <div><p style="color:#FFF">${live.vcount}</p>
                        <p style="font-size:0.6em">粉丝人数</p></div>
                </div>
            </div>
        </div>
            ...
            <div id="product-c">
                ...
                <div class="product-item">
                    ...
                    <div class="product-info">
                        ...
                        <p class="p-price"><span><i class="f-a">&yen;&nbsp;</i>{{item.minPrice}}</span>{{if
                            item.minPrice < item.originalPrice }}<s>&yen;&nbsp;{{item.originalPrice}}</s>{{/if}}</p>
                    </div>
