...
<div class="section lazyload">
    ...
    <#if pager.list?exists && pager.list?size gt 0>
		...
		<img src="${static_base}/m/img/blank100x157.png"
             data-image="<#if list.productImageCover?index_of('http') != -1>${list.productImageCover}<#else>${picture_base}${list.productImageCover}</#if>"
        ...
        <#if pager.pageCount gt 1>
            ...
            <div class="load-more scroll-load-more" data-url="/product/pager?${param}" data-target="load-more-product"
