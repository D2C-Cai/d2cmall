        ...
        <div class="form">
            <#if !LOGINMEMBER.d2c>
                <form class="validate-form" action="/member/bind" method="post" call-back="bindSucess">
                    ...
                    <div class="form-item">
                        <input type="text" name="loginCode" id="loginCode" value=""
                               class="input validate validate-account" title="账号" placeholder="请输入你的D2C账号(邮箱或手机)"/>
                    </div>
                    <div class="message"
                    ...
                    <div class="form-button">
                        <button type="button" name="sure-button" id="sure-button" class="button button-l button-red">
                            确定
                        </button>
                    </div>
                </form>
