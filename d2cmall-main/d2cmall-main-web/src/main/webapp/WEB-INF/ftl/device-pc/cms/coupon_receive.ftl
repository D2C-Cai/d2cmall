    ...
    <div class="text-center padding" style="line-height:250%;padding-top:30%;">
        ...
        <div>
            ...
            <div>
                ...
                <#else>
                    <div class="form-item">
                        <input type="text" name="mobile" id="mobile" value="" class="input validate" title="手机号码"
                               placeholder="请输入手机号码"/>
                ...
                <div class="coupon-button">
                    <a href="javascript:" data-url="${result.datas.receiveUrl}" success-tip="恭喜您！领取成功!"
                       fail-tip="优惠券领取不成功！" class="button button-red ajax-request active-coupon">立即领取</a>
                </div>
                </#if>
