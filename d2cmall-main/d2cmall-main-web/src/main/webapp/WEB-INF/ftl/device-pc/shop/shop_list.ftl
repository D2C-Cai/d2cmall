...
<div class="layout layout-response designer-list lazyload clearfix">
    <div class="suspend-navs-showroom scroll-suspend">
        ...
        <a class="nav-show-detail" href="javascript:;" data-url="/showroom/category/style" data-status="off"
           data-id="198">按风格</a>
        <div class="suspend-navs-children">
            <div class="nav-children">
            </div>
        </div>
        <a class="nav-show-detail" href="javascript:;" data-url="/showroom/category/designArea" data-status="off"
           data-id="199">按分类</a>
        <div class="suspend-navs-children">
            <div class="nav-children">
            </div>
        </div>
        <a class="nav-show-detail" href="javascript:;" data-url="/showroom/category/country" data-status="off"
           data-id="200">按地区</a>
        <div class="suspend-navs-children">
            <div class="nav-children">
            </div>
    ...
    <div style="margin-top:20px;">
        <#list pager.list as designer>
            <#if designer.introPic !='' && designer.introPic?length gt 0>
                <a href="/showroom/designer/${designer.id}" target="_blank"><img alt="${designer.name}"
                                                                                 src="${static_base}/blank/300-470.gif"
                                                                                 data-image="${picture_base}${(designer.introPic)!}"/></a>
            </#if>
        </#list>
    </div>
</div>
