        ...
        <div class="account-wrap">
            <form name="form-register" id="form-register" action="/member/register" method="post">
                ...
                <div class="service-dtail checkbox">
                    <input type="checkbox" id="checkbox" checked/><label for="checkbox"></label><span
                            style="font-size:14px;">立即注册代表同意<a href="/page/regagreement"
                                                               target="_blank">《D2C网络服务使用协议》</a></span>
                </div>
